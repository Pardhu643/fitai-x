...
export function Navigation() {
  ...
  return (
    <aside className="w-72 bg-[#151515] border-r border-[#1B1B1B] flex flex-col justify-between h-full p-6 select-none flex-shrink-0 z-40">
      {/* Top Section */}
      ...
      <div className="space-y-6">
        {/* Upgrade to Pro Card */}
        <div className="bg-[#1B1B1B] border border-[#2c2c2c] rounded-2xl p-4 text-center relative overflow-hidden group">
          ...
          <p className="text-xs text-gray-400 mb-3 leading-relaxed">Unlock AI Coach, advanced insights and more.</p>
          <button className="w-full bg-[#FFC400] hover:bg-[#e0ad00] text-black text-xs font-bold py-2 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-1">
            Upgrade Now
        ...
        <div className="flex items-center justify-between border-t border-[#1B1B1B] pt-4 px-2">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-[#FFC400] text-black font-extrabold flex items-center justify-center text-xs">
            ...
            <div className="text-left max-w-[120px] truncate">
              ...
              <span className="block text-[10px] text-gray-500 truncate">Level 3 • 1,240 XP</span>
            </div>
          </div>
          <button 
            onClick={handleLogout}
            className="p-2 text-gray-400 hover:text-white hover:bg-[#1B1B1B] rounded-lg transition-all duration-200"
            aria-label="Sign Out"
          >
            <LogOut size={18} />
          </button>
