...
export const versionControlController = {
  getVersions: async (req: Request, res: Response): Promise<any> => {
  ...
  getVersionSnapshot: async (req: Request, res: Response): Promise<any> => {
    const userId = (req as AuthRequest).user.userId;
  ...
  rollback: async (req: Request, res: Response): Promise<any> => {
    const userId = (req as AuthRequest).user.userId;
    const { id: planId } = req.params;
